...
class UserInfo(models.Model):
    username = models.CharField(verbose_name='用户名', max_length=32, db_index=True)  # db_index=True 创建索引查询更快
...
class Transaction(models.Model):
    ...
    order = models.CharField(verbose_name='订单号', max_length=64, unique=models.CASCADE)  # 唯一索引
